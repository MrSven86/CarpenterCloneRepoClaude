    ...
    extend: {
      ...
      colors: {
        ...
        salon: {
          ...
          text: "hsl(var(--salon-text))",
          light: "hsl(var(--salon-light))",
          teal: "hsl(var(--salon-teal))",
          "teal-light": "hsl(var(--salon-teal-light))",
          orange: "hsl(var(--salon-orange))",
          "footer-bg": "hsl(var(--salon-footer-bg))",
        },
        sidebar: {
